...
const SHELL = 'fishin-shell-v3';
const DATA  = 'fishin-data-v3';
const FILES = ['./', './index.html', './manifest.json', './manifest.webmanifest',
               './icon-64.png', './icon-192.png', './icon-512.png', './icon-maskable.png'];
